      ...
      <RevealOnScroll>
        <div className='max-w-5xl mx-auto px-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <Project name='PetSphere' description='A React-based e-commerce web application built to simplify online shopping for pet parents' techStack={['React', 'JavaScript', 'React Router DOM', 'Tailwind CSS', 'JSON Server']} link='https://github.com/Hardik0602/PetSphere' />
            ...
            <Project name='React Jobs' description='A React-based web application designed to provide a simple and intuitive interface for browsing, adding, editing, and deleting job listings related to React and React Native roles' techStack={['React', 'JavaScript', 'React Router DOM', 'Tailwind CSS', 'JSON Server']} link='https://github.com/Hardik0602/React-Jobs' />
